...
def build_codemap(modules):
    ...
    lines.append("- `docs/AI_CONTEXT_CURRENT.md` — AI routing + active/legacy context\n")
    lines.append("- `docs/canonical/WORKFLOW_CODEX.md` — Codex implementation workflow\n")
    lines.append("- `docs/GPT_SNAPSHOT.md` — current AI onboarding context\n")
    lines.append("- `docs/archive/ai_context/` — archived AI context history (optional reference)\n")
    lines.append("- `reports/runs/YYYY/MM/DD/<run_id>/` — per-run report artifacts\n")
    lines.append("- `reports/daily/YYYY/MM/DD/report.json` — canonical daily report path\n")
    lines.append("- `snapshots/runs/YYYY/MM/DD/<run_id>/run.manifest.json` — canonical run manifest path\n\n")
    lines.append("---\n\n")
