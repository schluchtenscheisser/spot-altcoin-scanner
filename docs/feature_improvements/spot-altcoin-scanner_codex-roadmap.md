...
2) **`improvements_existing_data.md`** (verbindliche Ergänzungen/Änderungen) im Repo im Ordner docs/feature_improvements
3) **`SCHEMA_CHANGES.md`** (separates Dokument für Schema-/Output‑Änderungen) im Repo im Ordner docs/
4) **`FEATURE_RULEBOOK.md`** separates Dokument im Repo im Ordner docs/
