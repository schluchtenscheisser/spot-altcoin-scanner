...
### Arbeitsregel 3 — Umgang mit erkannten Konzeptverbesserungen oder Optimierungsideen

Gesamtkonzept, Abschnittsdateien und dieses Addendum geben die grundsätzliche Roadmap und Entwicklungsrichtung vor.

Wenn im Ticket-Abstimmungs-, Review- oder Ausarbeitungsprozess erkennbar wird, dass:

- die bestehende Konzeption an einer Stelle mangelhaft sein könnte,
- eine Inkonsistenz vorliegt,
- oder eine Abweichung eine echte Optimierung des Konzepts darstellen würde,

dann darf diese Erkenntnis **nicht stillschweigend** in Ticket, Review oder Implementierung übernommen werden.

Stattdessen gilt:

1. Die bestehende autoritative Referenzmenge bleibt bis zu einer expliziten Entscheidung maßgeblich.
2. Die erkannte Stelle ist **explizit** als potenzielle Konzeptabweichung, Konzeptverbesserung oder Optimierung zu markieren.
3. Die potenzielle Optimierung ist mit Martin als Endnutzer ausdrücklich abzustimmen.
4. Ohne diese Abstimmung darf keine stille konzeptionelle Drift entstehen.

### Arbeitsregel 4 — Ausgabe von Ticket-Entwürfen

Ticket-Entwürfe sollen immer als **Markdown-Datei zum Download** ausgegeben werden und **nie nur als reiner Text im Chat**.

Das gilt für:

- Erstentwürfe
- überarbeitete Fassungen
- nach Review-Kommentaren korrigierte Fassungen
- finale abgestimmte Ticketversionen
