...
**Last Updated:** 2026-02-22 11:09 UTC  
...
**Module Variables:** `alpha, ath, atr, atr_pct, atr_pct_series, atr_rank_lookback, atr_rank_window, avg_rank, bars, base_features` _(+73 more)_
...
| `_calc_atr_pct_series` | — | `full`, `nanmean` |
...
|--------|----------------|----------------|-------|----------|
| `scanner/pipeline/features.py` | 29 | 46 | 75 | 🔴 High |
...
_Generated by GitHub Actions • 2026-02-22 11:09 UTC_
