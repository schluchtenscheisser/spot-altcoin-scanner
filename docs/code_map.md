...
**Last Updated:** 2026-02-20 23:02 UTC  
...
**Functions:** `_evaluate_candidate, _extract_backtest_config, _float_or_none, _setup_triggered, _summarize, run_backtest_from_history, run_backtest_from_snapshots`

**Module Variables:** `all_dates, bt, cfg, close, end_excl, entry_price, event, f, features, high` _(+28 more)_

**Imports:** `__future__, collections, json, pathlib, typing`
...
| Calling Function | Internal Calls | External Calls |
|------------------|----------------|----------------|
| `_evaluate_candidate` | `_setup_triggered` | `update` |
...
| `scanner/pipeline/__init__.py` | 0 | 41 | 41 | 🔴 High |
...
| `scanner/pipeline/backtest_runner.py` | 7 | 13 | 20 | 🔴 High |
...
_Generated by GitHub Actions • 2026-02-20 23:02 UTC_
