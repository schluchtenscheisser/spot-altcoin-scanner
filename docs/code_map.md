...
**Last Updated:** 2026-02-13 21:27 UTC  
...
**Module Variables:** `alpha, ath, atr, base_score, close_time, closes, converted, current, drawdown_lookback, ema` _(+34 more)_
...
|--------|----------------|----------------|-------|----------|
| `scanner/pipeline/features.py` | 19 | 35 | 54 | 🔴 High |
...
_Generated by GitHub Actions • 2026-02-13 21:27 UTC_
