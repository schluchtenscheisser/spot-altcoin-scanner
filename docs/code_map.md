...
**Last Updated:** 2026-03-09 10:06 UTC  
...
**Module Variables:** `allowed_keys, analysis, asof_iso, asof_ts_ms, candidate, canonical_schema_version, coin_name, components, counts, data_freshness` _(+61 more)_
...
| `_build_trade_candidates` | `_resolve_planned_entry_price`, `_sanitize_bool_or_none`, `_sanitize_directional_volume_preparation`, `_sanitize_float_or_none`, `_sanitize_positive_float_or_none`, `_sanitize_reason_list` | `append`, `get`, `sort` |
...
|--------|----------------|----------------|-------|----------|
| `scanner/pipeline/output.py` | 27 | 67 | 94 | 🔴 High |
