...
- Persisted allowlist: `reports/index/latest.json`, `reports/index/latest_daily.json`, `reports/index/latest_confirmed_candidates.json`, `reports/index/latest_watchlist.json`, `reports/index/latest_paths.json`, `reports/index/recent_runs.json`, `reports/daily/YYYY/MM/DD/report.json`, and `reports/runs/YYYY/MM/DD/<run_id>/report.json`.
