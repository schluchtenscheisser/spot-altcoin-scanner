...
Ergänze Unit-Tests für EMA und ATR.

## Akzeptanzkriterien
- EMA und ATR haben deterministische Tests mit bekannten Fixtures.
- Edge Cases (kurze Reihen) abgedeckt.
- Tests schnell und ohne externe Abhängigkeiten.
